...
FREERTOS_DIR :=../libs/FreeRTOS/FreeRTOS/Source
...
FREERTOS_OBJ = $(SRC:%.c=$(BUILD_DIR)/%.o)

ifeq ($(strip $(OPENCM3_DIR)),)
# user has not specified the library path, so we try to detect it

# where we search for the library
LIBPATHS := ./libopencm3 ../libs/libopencm3 ../
...
DEFS        += -I$(FREERTOS)/include
DEFS        += -I$(FREERTOS)/portable/GCC/ARM_CM4F
